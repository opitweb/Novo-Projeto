...
export default function SobrePage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <main>
        {/* HEADER DA PÁGINA - Cores Aprovadas */}
        <section className="pt-48 pb-24 bg-white text-center px-6">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-7xl md:text-8xl font-bold text-[#0A1738] tracking-tighter mb-8 leading-none animate-reveal">
              Nuestra <span className="font-light italic text-[#0DBAAC]">misión</span>
            </h1>
            <p className="text-2xl text-slate-500 font-light max-w-2xl mx-auto leading-relaxed animate-reveal delay-100">
              Humanizar la tecnología para conectar doctores y pacientes de forma ética, nítida y elegante.
            </p>
          </div>
        </section>
