      ...
      <main className="relative z-10">
        ...
        <section className="pt-48 pb-24 text-center px-6">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-7xl md:text-8xl font-bold text-[#0A1738] tracking-tighter mb-8 animate-fadeInDown">
              Hablemos
            </h1>
            <p className="text-xl text-slate-500 italic border-l-2 border-[#0DBAAC] inline-block pl-6 max-w-2xl text-left animate-fadeIn">
        ...
        <section className="py-24 max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-12">
            {services.map((service, index) => (
              <div
                key={index}
                className="bg-white p-12 rounded-[3.5rem] shadow-sm border border-slate-50 hover:shadow-2xl transition-all duration-500 group animate-fadeInUp"
        ...
        <section className="py-32 px-6">
          <div className="max-w-6xl mx-auto bg-[#0A1738] rounded-[4rem] p-12 md:p-24 text-center text-white shadow-2xl relative overflow-hidden animate-fadeIn">
            ...
            <div className="relative z-10">
              <h2 className="text-4xl md:text-7xl font-bold mb-10 tracking-tighter">
                ...
                <span className="text-[#0DBAAC] italic font-light">su agenda?</span>
              </h2>
